...
#define FA_ALL { FA_ADJUST,FA_ADN,FA_ALIGN_CENTER,FA_ALIGN_JUSTIFY,FA_ALIGN_LEFT,FA_ALIGN_RIGHT,FA_AMBULANCE,FA_ANCHOR,FA_ANDROID,FA_ANGLE_DOUBLE_DOWN,FA_ANGLE_DOUBLE_LEFT,FA_ANGLE_DOUBLE_RIGHT,FA_ANGLE_DOUBLE_UP,FA_ANGLE_DOWN,FA_ANGLE_LEFT,FA_ANGLE_RIGHT,FA_ANGLE_UP,FA_APPLE,FA_ARCHIVE,FA_ARROW_CIRCLE_DOWN,FA_ARROW_CIRCLE_LEFT,FA_ARROW_CIRCLE_O_DOWN,FA_ARROW_CIRCLE_O_LEFT,FA_ARROW_CIRCLE_O_RIGHT,FA_ARROW_CIRCLE_O_UP,FA_ARROW_CIRCLE_RIGHT,FA_ARROW_CIRCLE_UP,FA_ARROW_DOWN,FA_ARROW_LEFT,FA_ARROW_RIGHT,FA_ARROW_UP,FA_ARROWS,FA_ARROWS_ALT,FA_ARROWS_H,FA_ARROWS_V,FA_ASTERISK,FA_AUTOMOBILE,FA_BACKWARD,FA_BAN,FA_BANK,FA_BAR_CHART_O,FA_BARCODE,FA_BARS,FA_BEER,FA_BEHANCE,FA_BEHANCE_SQUARE,FA_BELL,FA_BELL_O,FA_BITBUCKET,FA_BITBUCKET_SQUARE,FA_BITCOIN,FA_BOLD,FA_BOLT,FA_BOMB,FA_BOOK,FA_BOOKMARK,FA_BOOKMARK_O,FA_BRIEFCASE,FA_BTC,FA_BUG,FA_BUILDING,FA_BUILDING_O,FA_BULLHORN,FA_BULLSEYE,FA_CAB,FA_CALENDAR,FA_CALENDAR_O,FA_CAMERA,FA_CAMERA_RETRO,FA_CAR,FA_CARET_DOWN,FA_CARET_LEFT,FA_CARET_RIGHT,FA_CARET_SQUARE_O_DOWN,FA_CARET_SQUARE_O_LEFT,FA_CARET_SQUARE_O_RIGHT,FA_CARET_SQUARE_O_UP,FA_CARET_UP,FA_CERTIFICATE,FA_CHAIN,FA_CHAIN_BROKEN,FA_CHECK,FA_CHECK_CIRCLE,FA_CHECK_CIRCLE_O,FA_CHECK_SQUARE,FA_CHECK_SQUARE_O,FA_CHEVRON_CIRCLE_DOWN,FA_CHEVRON_CIRCLE_LEFT,FA_CHEVRON_CIRCLE_RIGHT,FA_CHEVRON_CIRCLE_UP,FA_CHEVRON_DOWN,FA_CHEVRON_LEFT,FA_CHEVRON_RIGHT,FA_CHEVRON_UP,FA_CHILD,FA_CIRCLE,FA_CIRCLE_O,FA_CIRCLE_O_NOTCH,FA_CIRCLE_THIN,FA_CLIPBOARD,FA_CLOCK_O,FA_CLOUD,FA_CLOUD_DOWNLOAD,FA_CLOUD_UPLOAD,FA_CNY,FA_CODE,FA_CODE_FORK,FA_CODEPEN,FA_COFFEE,FA_COG,FA_COGS,FA_COLUMNS,FA_COMMENT,FA_COMMENT_O,FA_COMMENTS,FA_COMMENTS_O,FA_COMPASS,FA_COMPRESS,FA_COPY,FA_CREDIT_CARD,FA_CROP,FA_CROSSHAIRS,FA_CSS3,FA_CUBE,FA_CUBES,FA_CUT,FA_CUTLERY,FA_DASHBOARD,FA_DATABASE,FA_DEDENT,FA_DELICIOUS,FA_DESKTOP,FA_DEVIANTART,FA_DIGG,FA_DOLLAR,FA_DOT_CIRCLE_O,FA_DOWNLOAD,FA_DRIBBBLE,FA_DROPBOX,FA_DRUPAL,FA_EDIT,FA_EJECT,FA_ELLIPSIS_H,FA_ELLIPSIS_V,FA_EMPIRE,FA_ENVELOPE,FA_ENVELOPE_O,FA_ENVELOPE_SQUARE,FA_ERASER,FA_EUR,FA_EURO,FA_EXCHANGE,FA_EXCLAMATION,FA_EXCLAMATION_CIRCLE,FA_EXCLAMATION_TRIANGLE,FA_EXPAND,FA_EXTERNAL_LINK,FA_EXTERNAL_LINK_SQUARE,FA_EYE,FA_EYE_SLASH,FA_FACEBOOK,FA_FACEBOOK_SQUARE,FA_FAST_BACKWARD,FA_FAST_FORWARD,FA_FAX,FA_FEMALE,FA_FIGHTER_JET,FA_FILE,FA_FILE_ARCHIVE_O,FA_FILE_AUDIO_O,FA_FILE_CODE_O,FA_FILE_EXCEL_O,FA_FILE_IMAGE_O,FA_FILE_MOVIE_O,FA_FILE_O,FA_FILE_PDF_O,FA_FILE_PHOTO_O,FA_FILE_PICTURE_O,FA_FILE_POWERPOINT_O,FA_FILE_SOUND_O,FA_FILE_TEXT,FA_FILE_TEXT_O,FA_FILE_VIDEO_O,FA_FILE_WORD_O,FA_FILE_ZIP_O,FA_FILES_O,FA_FILM,FA_FILTER,FA_FIRE,FA_FIRE_EXTINGUISHER,FA_FLAG,FA_FLAG_CHECKERED,FA_FLAG_O,FA_FLASH,FA_FLASK,FA_FLICKR,FA_FLOPPY_O,FA_FOLDER,FA_FOLDER_O,FA_FOLDER_OPEN,FA_FOLDER_OPEN_O,FA_FONT,FA_FORWARD,FA_FOURSQUARE,FA_FROWN_O,FA_GAMEPAD,FA_GAVEL,FA_GBP,FA_GE,FA_GEAR,FA_GEARS,FA_GIFT,FA_GIT,FA_GIT_SQUARE,FA_GITHUB,FA_GITHUB_ALT,FA_GITHUB_SQUARE,FA_GITTIP,FA_GLASS,FA_GLOBE,FA_GOOGLE,FA_GOOGLE_PLUS,FA_GOOGLE_PLUS_SQUARE,FA_GRADUATION_CAP,FA_GROUP,FA_H_SQUARE,FA_HACKER_NEWS,FA_HAND_O_DOWN,FA_HAND_O_LEFT,FA_HAND_O_RIGHT,FA_HAND_O_UP,FA_HDD_O,FA_HEADER,FA_HEADPHONES,FA_HEART,FA_HEART_O,FA_HISTORY,FA_HOME,FA_HOSPITAL_O,FA_HTML5,FA_IMAGE,FA_INBOX,FA_INDENT,FA_INFO,FA_INFO_CIRCLE,FA_INR,FA_INSTAGRAM,FA_INSTITUTION,FA_ITALIC,FA_JOOMLA,FA_JPY,FA_JSFIDDLE,FA_KEY,FA_KEYBOARD_O,FA_KRW,FA_LANGUAGE,FA_LAPTOP,FA_LEAF,FA_LEGAL,FA_LEMON_O,FA_LEVEL_DOWN,FA_LEVEL_UP,FA_LIFE_BOUY,FA_LIFE_RING,FA_LIFE_SAVER,FA_LIGHTBULB_O,FA_LINK,FA_LINKEDIN,FA_LINKEDIN_SQUARE,FA_LINUX,FA_LIST,FA_LIST_ALT,FA_LIST_OL,FA_LIST_UL,FA_LOCATION_ARROW,FA_LOCK,FA_LONG_ARROW_DOWN,FA_LONG_ARROW_LEFT,FA_LONG_ARROW_RIGHT,FA_LONG_ARROW_UP,FA_MAGIC,FA_MAGNET,FA_MAIL_FORWARD,FA_MAIL_REPLY,FA_MAIL_REPLY_ALL,FA_MALE,FA_MAP_MARKER,FA_MAXCDN,FA_MEDKIT,FA_MEH_O,FA_MICROPHONE,FA_MICROPHONE_SLASH,FA_MINUS,FA_MINUS_CIRCLE,FA_MINUS_SQUARE,FA_MINUS_SQUARE_O,FA_MOBILE,FA_MOBILE_PHONE,FA_MONEY,FA_MOON_O,FA_MORTAR_BOARD,FA_MUSIC,FA_NAVICON,FA_OPENID,FA_OUTDENT,FA_PAGELINES,FA_PAPER_PLANE,FA_PAPER_PLANE_O,FA_PAPERCLIP,FA_PARAGRAPH,FA_PASTE,FA_PAUSE,FA_PAW,FA_PENCIL,FA_PENCIL_SQUARE,FA_PENCIL_SQUARE_O,FA_PHONE,FA_PHONE_SQUARE,FA_PHOTO,FA_PICTURE_O,FA_PIED_PIPER,FA_PIED_PIPER_ALT,FA_PIED_PIPER_SQUARE,FA_PINTEREST,FA_PINTEREST_SQUARE,FA_PLANE,FA_PLAY,FA_PLAY_CIRCLE,FA_PLAY_CIRCLE_O,FA_PLUS,FA_PLUS_CIRCLE,FA_PLUS_SQUARE,FA_PLUS_SQUARE_O,FA_POWER_OFF,FA_PRINT,FA_PUZZLE_PIECE,FA_QQ,FA_QRCODE,FA_QUESTION,FA_QUESTION_CIRCLE,FA_QUOTE_LEFT,FA_QUOTE_RIGHT,FA_RA,FA_RANDOM,FA_REBEL,FA_RECYCLE,FA_REDDIT,FA_REDDIT_SQUARE,FA_REFRESH,FA_RENREN,FA_REORDER,FA_REPEAT,FA_REPLY,FA_REPLY_ALL,FA_RETWEET,FA_RMB,FA_ROAD,FA_ROCKET,FA_ROTATE_LEFT,FA_ROTATE_RIGHT,FA_ROUBLE,FA_RSS,FA_RSS_SQUARE,FA_RUB,FA_RUBLE,FA_RUPEE,FA_SAVE,FA_SCISSORS,FA_SEARCH,FA_SEARCH_MINUS,FA_SEARCH_PLUS,FA_SEND,FA_SEND_O,FA_SHARE,FA_SHARE_ALT,FA_SHARE_ALT_SQUARE,FA_SHARE_SQUARE,FA_SHARE_SQUARE_O,FA_SHIELD,FA_SHOPPING_CART,FA_SIGN_IN,FA_SIGN_OUT,FA_SIGNAL,FA_SITEMAP,FA_SKYPE,FA_SLACK,FA_SLIDERS,FA_SMILE_O,FA_SORT,FA_SORT_ALPHA_ASC,FA_SORT_ALPHA_DESC,FA_SORT_AMOUNT_ASC,FA_SORT_AMOUNT_DESC,FA_SORT_ASC,FA_SORT_DESC,FA_SORT_DOWN,FA_SORT_NUMERIC_ASC,FA_SORT_NUMERIC_DESC,FA_SORT_UP,FA_SOUNDCLOUD,FA_SPACE_SHUTTLE,FA_SPINNER,FA_SPOON,FA_SPOTIFY,FA_SQUARE,FA_SQUARE_O,FA_STACK_EXCHANGE,FA_STACK_OVERFLOW,FA_STAR,FA_STAR_HALF,FA_STAR_HALF_EMPTY,FA_STAR_HALF_FULL,FA_STAR_HALF_O,FA_STAR_O,FA_STEAM,FA_STEAM_SQUARE,FA_STEP_BACKWARD,FA_STEP_FORWARD,FA_STETHOSCOPE,FA_STOP,FA_STRIKETHROUGH,FA_STUMBLEUPON,FA_STUMBLEUPON_CIRCLE,FA_SUBSCRIPT,FA_SUITCASE,FA_SUN_O,FA_SUPERSCRIPT,FA_SUPPORT,FA_TABLE,FA_TABLET,FA_TACHOMETER,FA_TAG,FA_TAGS,FA_TASKS,FA_TAXI,FA_TENCENT_WEIBO,FA_TERMINAL,FA_TEXT_HEIGHT,FA_TEXT_WIDTH,FA_TH,FA_TH_LARGE,FA_TH_LIST,FA_THUMB_TACK,FA_THUMBS_DOWN,FA_THUMBS_O_DOWN,FA_THUMBS_O_UP,FA_THUMBS_UP,FA_TICKET,FA_TIMES,FA_TIMES_CIRCLE,FA_TIMES_CIRCLE_O,FA_TINT,FA_TOGGLE_DOWN,FA_TOGGLE_LEFT,FA_TOGGLE_RIGHT,FA_TOGGLE_UP,FA_TRASH_O,FA_TREE,FA_TRELLO,FA_TROPHY,FA_TRUCK,FA_TRY,FA_TUMBLR,FA_TUMBLR_SQUARE,FA_TURKISH_LIRA,FA_TWITTER,FA_TWITTER_SQUARE,FA_UMBRELLA,FA_UNDERLINE,FA_UNDO,FA_UNIVERSITY,FA_UNLINK,FA_UNLOCK,FA_UNLOCK_ALT,FA_UNSORTED,FA_UPLOAD,FA_USD,FA_USER,FA_USER_MD,FA_USERS,FA_VIDEO_CAMERA,FA_VIMEO_SQUARE,FA_VINE,FA_VK,FA_VOLUME_DOWN,FA_VOLUME_OFF,FA_VOLUME_UP,FA_WARNING,FA_WECHAT,FA_WEIBO,FA_WEIXIN,FA_WHEELCHAIR,FA_WINDOWS,FA_WON,FA_WORDPRESS,FA_WRENCH,FA_XING,FA_XING_SQUARE,FA_YAHOO,FA_YEN,FA_YOUTUBE,FA_YOUTUBE_PLAY,FA_YOUTUBE_SQUARE }
